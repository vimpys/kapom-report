...
See [`examples/`](examples) for 13 runnable demos covering every feature above — run any of them directly with `npx tsx examples/<file>.ts`, or `npm run demo` to generate all of them at once into `examples/output/`.
