 ...
 *
 * Run with: `tsx examples/06-master-detail/index.ts`
 */
...
report.save(outPath('06-master-detail'));
console.log(`OK 06-master-detail.pdf (${report.doc.getNumberOfPages()} pages)`);
