 ...
 *
 * Run with: `tsx examples/08-signature-watermark/index.ts`
 */
...
report.save(outPath('08-signature-watermark'));
console.log(`OK 08-signature-watermark.pdf (${report.doc.getNumberOfPages()} pages)`);
